...
- **Continue Implementation** → `speckit-implement`: Continue implementing tasks with the updated spec documents
- **Analyze For Consistency** → `speckit-analyze`: Run a project analysis for consistency after the iteration
