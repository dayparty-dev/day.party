...
> _Failed test: {TC-ID} — {test file path}_
> _Expected behavior per spec: {AC text}_
> _Evidence: {error + screenshot description}_
> _Gap analysis: {implementation / spec / test gap}_
> _Fix ONLY what's needed to make this test pass without breaking others._
> _After fixing, report: files changed + description of change."_
