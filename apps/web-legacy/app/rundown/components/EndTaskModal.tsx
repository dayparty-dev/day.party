...
export default function EndTaskModal({ task, setShowEndModal }: EndTaskModalProps) {
    ...
    <dialog className="modal modal-open">
      <div className="modal-box">
        ...
        <div className="py-4 flex flex-col gap-2">
          <button className="btn btn-outline" onClick={() => handleAddMinutes(5)}>
            +5 {t('task.minutes')}
          </button>
          <button className="btn btn-outline" onClick={() => handleAddMinutes(10)}>
            +10 {t('task.minutes')}
          </button>
          <input
            type="number"
