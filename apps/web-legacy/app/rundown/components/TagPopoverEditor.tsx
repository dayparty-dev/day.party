...
const TagPopoverEditor: React.FC<TagPopoverEditorProps> = ({
  ...
  return (
    ...
    <div
      ref={popoverRef}
      className="absolute bg-base-100 border shadow-lg rounded-2xl bottom-full max-w-[350px] md:max-w-[435px] lg:max-w-[600px]"
    >
      <div className="relative p-4">
        <TagSelector selectedKey={selectedKey} onSelect={handleSelect} />
