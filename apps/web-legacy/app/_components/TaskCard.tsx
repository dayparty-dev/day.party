...
const TaskCard: React.FC<TaskCardProps> = ({ task }) => {
  ...
  const totalDuration = Math.floor((dueDate.getTime() - scheduledAt.getTime()) / 1000); // Duración total en segundos
  ...
  return (
    <div className="task-card">
      ...
      <p>¿Listo para comenzar? La tarea empieza el {scheduledAt.toLocaleString()}</p>
    </div>
  );
};
