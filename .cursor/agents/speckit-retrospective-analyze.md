...
- **Update Constitution** → `speckit-constitution`: Update constitution based on retrospective learnings
- **Create New Feature** → `speckit-specify`: Create a new feature incorporating learnings from retrospective
- **Create Checklist** → `speckit-checklist`: Create checklist based on retrospective findings
