...
8. **Testing phases are optional.** After Phase 7 always ask: _"Run test planning and execution (Phases 8A–8B)? Recommended for Must Have features."_ Respect the user's choice — skip cleanly if declined.
...
- Ask: _"Research complete. Approve and move to Product Spec creation, or request additional research dimensions?"_
...
- Ask: _"Product spec created with [N] documents. Approve and move to Revalidation, or go back to revise?"_
...
- Confirm approval
- Ask: _"Product spec approved and locked. Ready to bridge to SpecKit?"_
...
- Ask: _"spec.md created. Approve and proceed to Plan + Tasks, or revise spec?"_
...
- Ask: _"Plan and tasks approved. Begin implementation?"_
...
- Ask: _"Implementation complete. Run full verification?"_
...
- Ask: _"Test plan created with [N] test cases across [N] test files. Approve and proceed to test execution?"_
